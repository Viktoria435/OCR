...
import { emojiByExtension } from "../utils/fileDisplayConfig";
               ...
               >
                  {uploadedDocuments.map((document) => (
                     <li
                        key={document.id}
                        onClick={() =>
                           !isOpening && handleTabClick(document.id)
                        }
                     ...
                     >
                        <input
                           ...
                           disabled={isOpening}
                        />
                        <label className="font-medium cursor-pointer whitespace-nowrap overflow-hidden text-ellipsis mr-10 hover:text-blue-900">
                           {getEmojiByFilename(document.filename)}{" "}
                           {document.filename}
                        </label>
                        <button
                           onClick={(e) => {
               ...
               <div className="w-full h-[70vh] mt-6 flex flex-col  overflow-auto bg-white p-4 rounded text-start break-words">
                  {/* <div className="flex justify-start">
                     <button
                        ...
                        className={`absolute cursor-pointer right-20 text-xl ${
                           isFilesUploading ? "hidden" : ""
                        }`}
                     >
                        <svg
                           xmlns="http://www.w3.org/2000/svg"
